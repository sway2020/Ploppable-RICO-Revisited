...
namespace PloppableRICO
{
	...
	public class BuildingToolDetour
	{
		private static bool Prefix (ref bool __result, BuildingInfo info, ref Building building)
		{
			...
			if (info.m_buildingAI is PloppableOffice || info.m_buildingAI is PloppableExtractor || info.m_buildingAI is PloppableResidentialAI || info.m_buildingAI is PloppableCommercial || info.m_buildingAI is PloppableIndustrial)
			{
